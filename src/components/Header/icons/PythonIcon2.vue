<template>
<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 40 40" nitefall="disabled">
	...
	<path d="m 9.5,30 c 0,-10 2.5,-10 10,-10 8.5,0 11,0 11,-10" stroke="white" fill="red"/>
</svg>
</template>
